...
function adicionar(){
    ...
    if(txtnum.value.length == 0 || num > 100 || números[números.indexOf(num)] == num){ //se não tiver nada ou numero digitado for acima de 100 ou numero[chave com base no numero digitado)] == numero digitado
